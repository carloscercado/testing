...
@Component({
  selector: 'show-sellers-products',
  templateUrl: './show.component.html',
  styleUrls: ['./show.component.scss']
})

export class ShowSellersProductsComponent implements OnInit {
  ...
  ngOnInit() {
    this.sellerId = this._route.snapshot.paramMap.get('profile_id');
 ...
 remove(tag: any): void {
  ...
  addRange(quantity, price) {
    ...
    let object = this;
    let url = API_ROUTES.createRange().replace(":type_profile", "sellers").replace(":profile_id", this.sellerId).replace(":product_id",this.productId);
  ...
  removeRange(range: any): void {
    ...
    this.rangesLoading=true;
    let object = this;
    let url = API_ROUTES.deletePriceRange().replace(':type_profile', 'sellers').replace(':profile_id', this.sellerId).replace(':product_id', this.productId).replace(':price_range_id', range.id);
  ...
  getProduct(){
    ...
    let object = this;
    let url = API_ROUTES.getProduct().replace(':type_profile', 'sellers').replace(':profile_id', this.sellerId).replace(':product_id', this.productId);
  ...
  updateProduct(){
    ...
    let url = API_ROUTES.updateProduct().replace(':type_profile', "sellers").replace(':profile_id', this.sellerId).replace(':product_id', this.productId);
  ...
  getMyProducts(){
    ...
    // this.generalLoading=true;
    let object = this;
    let url = API_ROUTES.getPymeProducts().replace(":profile_id", this.sellerId);
    this._tokenService.get(url).subscribe(
      data =>      {
        data = JSON.parse(data['_body']);
        if (data['data'].length)
  ...
  getCategories(){
    this.generalLoading=true;
    let object = this;
    let url = API_ROUTES.getSubcategories().replace(':profile_id', this.sellerId);
    this._tokenService.get(url).subscribe(
      data =>      {
      ...
      error =>  {
        ...
        if("_body" in error){
          ...
          // this.toastr.error("Error al obtener las Sellers", 'Pyme Error');
        }
      }
    );
  }
  ...
  createCustomField() {
    ...
    let object = this;
    let url = API_ROUTES.productCreateCustomFields().replace(':type_profile', "sellers").replace(':profile_id', this.sellerId).replace(':product_id', this.productId);
  ...
  removeCustomField(custom: any): void {
    ...
    this.customLoading = true;
    let object = this;
    let url = API_ROUTES.productDeleteCustomFields().replace(':type_profile', 'sellers').replace(':profile_id', this.sellerId).replace(':product_id', this.productId).replace(':custom_field_id', custom.id);
    this._tokenService.delete(url).subscribe(
      data =>      {
        this.product = JSON.parse(data['_body']);
        this.product = this.product['data']
  ...
  createOption() {
    ...
    let object = this;
    let url = API_ROUTES.productCreateOptions().replace(':type_profile', "sellers").replace(':profile_id', this.sellerId).replace(':product_id', this.productId);
  ...
  deleteOption(option: any): void {
    ...
    this.optionsLoading = true;
    let object = this;
    let url = API_ROUTES.productDeleteOptions().replace(':type_profile', 'sellers').replace(':profile_id', this.sellerId).replace(':product_id', this.productId).replace(':option_id', option.id);
    this._tokenService.delete(url).subscribe(
      data =>      {
        this.product = JSON.parse(data['_body']);
        this.product = this.product['data']
